...
def calculate_extended_alpha_factors(df):
    ...
    try:
        from crypto_analysis.crypto_data_analysis_new import prepare_df
        # Import the original alpha functions (1-101)
        from crypto_analysis.crypto_data_analysis_new import alpha1, alpha2, alpha3, alpha4, alpha5, alpha6, alpha7, alpha8, alpha9, alpha10
        from crypto_analysis.crypto_data_analysis_new import alpha11, alpha12, alpha13, alpha14, alpha15, alpha16, alpha17, alpha18, alpha19, alpha20
        from crypto_analysis.crypto_data_analysis_new import alpha21, alpha22, alpha23, alpha24, alpha25, alpha26, alpha27, alpha28, alpha29, alpha30
        from crypto_analysis.crypto_data_analysis_new import alpha31, alpha32, alpha33, alpha34, alpha35, alpha36, alpha37, alpha38, alpha39, alpha40
        from crypto_analysis.crypto_data_analysis_new import alpha41, alpha42, alpha43, alpha44, alpha45, alpha46, alpha47, alpha48, alpha49, alpha50
        from crypto_analysis.crypto_data_analysis_new import alpha51, alpha52, alpha53, alpha54, alpha55, alpha56, alpha57, alpha58, alpha59, alpha60
        from crypto_analysis.crypto_data_analysis_new import alpha61, alpha62, alpha63, alpha64, alpha65, alpha66, alpha67, alpha68, alpha69, alpha70
        from crypto_analysis.crypto_data_analysis_new import alpha71, alpha72, alpha73, alpha74, alpha75, alpha76, alpha77, alpha78, alpha79, alpha80
        from crypto_analysis.crypto_data_analysis_new import alpha81, alpha82, alpha83, alpha84, alpha85, alpha86, alpha87, alpha88, alpha89, alpha90
        from crypto_analysis.crypto_data_analysis_new import alpha91, alpha92, alpha93, alpha94, alpha95, alpha96, alpha97, alpha98, alpha99, alpha100, alpha101
