...
try:
    from crypto_analysis.crypto_strategy import calculate_extended_alpha_factors  # type: ignore
except Exception:
...
def compute_fixed_top_alphas(df: pd.DataFrame, top_alphas: list[str]) -> pd.DataFrame:
    ...
    try:
        from crypto_analysis.crypto_data_analysis_new import prepare_df, alpha15, alpha31, alpha42, alpha97, alpha100
    ...
    try:
        ...
        from crypto_analysis.additional_alpha_factors import (
    ...
    try:
        ...
        from crypto_analysis.extended_alpha_factors import (
